package com.offcn.springbootsdut.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("spring-test-interface")
                ...
                .select()
                //加载swagger 扫描包
                .apis(RequestHandlerSelectors.basePackage("com.offcn.springbootsdut.controller"))
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("offcn", "", "123123@163.com");
        return new ApiInfoBuilder().title("swagger 测试文档").description("dev").contact(contact)
                .version("1.0.0").build();
    }
